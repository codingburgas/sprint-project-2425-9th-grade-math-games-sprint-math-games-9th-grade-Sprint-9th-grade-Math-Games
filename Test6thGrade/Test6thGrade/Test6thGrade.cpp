...
int main() {
    ...
    Question questions[] = {
        {"What is the name of the longest side of a right triangle?", "hypotenuse" },
        {"What is the name of the line that is twice the radius in a circle?", "diameter"},
        {"Which figure with a square base and triangular sides meeting at a point?", "pyramid"}
